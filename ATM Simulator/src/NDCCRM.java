 ...
 * @author it207440
 */
public class NDCCRM extends javax.swing.JFrame {
    ...
    public void setDeviceDetails(String atmStatus) {
        ...
        Other other = new Other();
        try {
            int cst1 = 3; //no cash loaded
            int cst2 = 3;//no cash loaded
            int cst3 = 3;//no cash loaded
            int cst4 = 3;//no cash loaded
            int rcpt = 1;
            int pinPad = 0;
            int drawer = 100;
            int card = 0;
            ...
            if (rcpt == 3) {
                other.selectButton("EMPTY / FAULT", BGRP);
            }
            //Pin Pad
            if (pinPad == 0) {
            ...
            if (drawer == 440) {
                other.selectButton("REJECT BIN OVER FILL", BGDISPENSER);
            }
            //Card Reader
            if (card == 0) {
...
//                    + rcpt + " " + pinPad + " " + drawer + " " + card + " " + stat + " " + state);
    ...
    private void initComponents() {
        ...
        cbDispenserRJOver = new javax.swing.JCheckBox();
        ...
        BGDISPENSER.add(cbDispenserRJOver);
        ...
        DispenserPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CURRUENCY ACCEPTOR", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Century", 0, 10))); // NOI18N
        ...
        cbDispenserRJOver.setFont(new java.awt.Font("Century", 0, 10)); // NOI18N
        cbDispenserRJOver.setText("REJECT BIN OVER FILL");
        ...
        DispenserPanelLayout.setHorizontalGroup(
            ...
            .addGroup(DispenserPanelLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cbDispenserRJOver)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        btnDeposit.setFont(new java.awt.Font("Century", 0, 10)); // NOI18N
            ...
            .addGroup(CSTOtherPanelLayout.createSequentialGroup()
                ...
                .addGroup(CSTOtherPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(CSTOtherPanelLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtWdAmount, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, CSTOtherPanelLayout.createSequentialGroup()
                        .addGap(82, 82, 82)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(CSTOtherPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(CSTDenomPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(PanelATMInfo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(CRPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(PinPadDenomPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(RPPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(DispenserPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(CSTPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnATMStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnATMStatusActionPerformed
        ...
        try {
            ...
            if (cbDispenserRJOver.isSelected()) {
                drawer = 440;
            }
            //Card Reader
...
//                        System.out.println(txtEndCash);
    ...
    private void btnDepositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDepositActionPerformed
        ...
        try {
            ...
            if ((denom1Val + denom2Val + denom3Val + denom4Val) > 0) {

                int denom1ValEnd = Integer.parseInt(txtDenomVal1.getText().trim());
                int denom2ValEnd = Integer.parseInt(txtDenomVal2.getText().trim());
                int denom3ValEnd = Integer.parseInt(txtDenomVal3.getText().trim());
                int denom4ValEnd = Integer.parseInt(txtDenomVal4.getText().trim());

                String inCash = other.getIncCash();
                int newInCash1 = Integer.parseInt(inCash.split("~")[0]) + denom1Val;
                int newInCash2 = Integer.parseInt(inCash.split("~")[1]) + denom2Val;
                int newInCash3 = Integer.parseInt(inCash.split("~")[2]) + denom3Val;
                int newInCash4 = Integer.parseInt(inCash.split("~")[3]) + denom4Val;

                String newInCash = newInCash1 + "~" + newInCash2 + "~" + newInCash3 + "~" + newInCash4;
                other.setIncCash(newInCash);
//                System.out.println(newInCash);

                int newEndCash1 = denom1ValEnd + denom1Val;
                int newEndCash2 = denom2ValEnd + denom2Val;
                int newEndCash3 = denom3ValEnd + denom3Val;
                int newEndCash4 = denom4ValEnd + denom4Val;

                String newEndCash = newEndCash1 + "~" + newEndCash2 + "~" + newEndCash3 + "~" + newEndCash4;
//                System.out.println(newEndCash);

                txtDenomVal1.setText(Integer.toString(newEndCash1));
                txtDenomVal2.setText(Integer.toString(newEndCash2));
                txtDenomVal3.setText(Integer.toString(newEndCash3));
                txtDenomVal4.setText(Integer.toString(newEndCash4));

                if (sql.updateATMCashIn(atm, newInCash, newEndCash) > 0) {
                    dg.dialogBox("Amount Updated...", this);
                } else {
                    JOptionPane.showMessageDialog(null, "Error in updating", "Error", JOptionPane.ERROR_MESSAGE);
                }
                ...
                JOptionPane.showMessageDialog(null, "No cash for deposit", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.toString(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private javax.swing.JCheckBox cbDispenserRJOver;
