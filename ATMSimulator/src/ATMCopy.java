 ...
 * @author it207440
 */
public class ATMCopy extends javax.swing.JFrame {
...
//                    + rcpt + " " + pinPad + " " + drawer + " " + card + " " + stat + " " + state);
    ...
    private void initComponents() {
            ...
            .addGroup(PanelATMInfoLayout.createSequentialGroup()
                ...
                .addGroup(PanelATMInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(PanelATMInfoLayout.createSequentialGroup()
                        .addComponent(lblATM)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtATM, javax.swing.GroupLayout.PREFERRED_SIZE, 243, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        txtDenom1Val.setEditable(false);
        ...
        txtDenom2Val.setEditable(false);
        ...
        txtDenom3Val.setEditable(false);
        ...
        txtDenom4Val.setEditable(false);
